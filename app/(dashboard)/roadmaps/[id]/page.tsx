...
export default async function RoadmapPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="min-h-screen bg-[#faf9f0] px-4 pb-32 pt-6 text-[#111820] sm:px-7 lg:px-10"><CharacterSelection /><div className="mx-auto max-w-330"><Link href="/roadmaps" className="font-pixel inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-black/55 transition hover:text-black"><ArrowLeft className="size-4" /> Todos os roadmaps</Link>
