...
type PlanEvent = { id: string; title: string; startAt: string; endAt: string | null; status: "PENDING" | "COMPLETED" | "CANCELED"; routineType: Kind; recurrence: "NONE" | "WEEKLY" | "CUSTOM"; recurrenceDays: number[]; recurrenceUntil: string | null; studySession: { courseId: string | null; subjectName: string | null } | null }
