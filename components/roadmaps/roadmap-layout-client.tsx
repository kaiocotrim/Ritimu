  ...
  return (
    <RoadmapDrawerContext.Provider value={{ isOpen, open, close, toggle }}>
      ...
      >
        ...
        <nav className="py-1" aria-label="Navegação do roadmap">
          <Link href="/roadmaps" onClick={close} className="font-pixel flex items-center gap-3 border-2 border-white/25 bg-white/10 px-4 py-3 text-[10px] font-bold uppercase tracking-wider text-white transition-colors hover:border-[#50D05C] hover:bg-white/15 hover:text-[#67e875]">
            <Map className="size-5 shrink-0 text-[#67e875]" aria-hidden="true" />
            <span>Todos os roadmaps</span>
          </Link>
        </nav>
      </aside>
