...
export function Sidebar() {
  ...
  return (
    <nav
      ...
      className={`fixed inset-x-0 bottom-8 z-20 mx-auto flex w-fit items-center gap-1 rounded-full border px-3 py-2.5 backdrop-blur-md backdrop-saturate-150 transition-all duration-300 ${
        isDarkPage
